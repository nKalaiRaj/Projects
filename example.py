...
print(int(ex2_number2)) # the int() function casts the float 99.99 to an integer
...
print("Example 3: ")
sum_of_num = 2 + 4 #Can't use the keyword 'sum' as that is a built-in python function
print(sum_of_num)
